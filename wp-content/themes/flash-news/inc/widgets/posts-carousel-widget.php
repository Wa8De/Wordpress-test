	...
	class Flash_News_Posts_Carousel_Widget extends WP_Widget {
		...
		public function form( $instance ) {
			...
			<p>
				...
				<input class="tiny-text" id="<?php echo esc_attr( $this->get_field_id( 'number' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'number' ) ); ?>" type="number" step="1" min="1" value="<?php echo absint( 4 ); ?>" size="3" />
			</p>
			<p>
