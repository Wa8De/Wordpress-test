...
if( ! function_exists( 'notation_blog_primary_navigation_fallback' ) ) :
	 ...
	 * @since 1.0.0
	 */
	function notation_blog_primary_navigation_fallback() {
		
		echo '<ul>';
			echo '<li><a href="' . esc_url( home_url( '/' ) ) . '">' .esc_html__( 'Home', 'notation-blog' ). '</a></li>';
			wp_list_pages( array(
			'title_li' => '',
			'depth'    => 1,
			'number'   => 5,
...
/**
 * Class notation_blog_Dropdown_Taxonomies_Control
 */
class notation_blog_Dropdown_Taxonomies_Control extends WP_Customize_Control {
    ...
    public function render_content() {
        $dropdown = wp_dropdown_categories(
            array(
                'name'              => 'notation-blog-dropdown-categories-' . $this->id,
                'echo'              => 0,
                'show_option_none'  => __( '&mdash; Select &mdash;', 'notation-blog' ),
                'option_none_value' => '0',
                'selected'          => $this->value(),
                'hide_empty'        => 0,                   
 ...
 */
class notation_blog_Repeater_Text_Control extends WP_Customize_Control {
    ...
    public function render_content() {
        ...
        <label class="repeater-text-input">
            ...
            <a href="#" class="button button-primary btn-add-field"><?php esc_html_e( 'Add New', 'notation-blog' ) ?></a>
 ...
 * @access public
 */
class notation_blog_Customize_Section_Upsell extends WP_Customize_Section {
     ...
     * @var    string
     */
    public $type = 'notation-blog-upsell';
