...
$default = notation_blog_get_default_theme_options();

// Add Panel.
$wp_customize->add_panel( 'theme_option_panel',
	array(
	'title'      => __( 'Theme Options', 'notation-blog' ),
	'priority'   => 150,
...
$wp_customize->add_section('section_sidebar_layout', array(    
	'title'       => __('Sidebar Layout', 'notation-blog'),
...
$wp_customize->add_setting('theme_options[layout_options_blog]', 
	...
	'type'              => 'theme_mod',
	'capability'        => 'edit_theme_options',
	'sanitize_callback' => 'notation_blog_sanitize_select'
	)
);

$wp_customize->add_control(new notation_blog_Image_Radio_Control($wp_customize, 'theme_options[layout_options_blog]', 
	array(		
	'label' 	=> __('Blog Layout', 'notation-blog'),
...
$wp_customize->add_control(new notation_blog_Image_Radio_Control($wp_customize, 'theme_options[layout_options_archive]', 
	array(		
	'label' 	=> __('Archive Layout', 'notation-blog'),
	'section' 	=> 'section_sidebar_layout',
...
$wp_customize->add_control(new notation_blog_Image_Radio_Control($wp_customize, 'theme_options[layout_options_page]', 
	array(		
	'label' 	=> __('Page Layout', 'notation-blog'),
	'section' 	=> 'section_sidebar_layout',
...
$wp_customize->add_control(new notation_blog_Image_Radio_Control($wp_customize, 'theme_options[layout_options_single]', 
	array(		
	'label' 	=> __('Single Post Layout', 'notation-blog'),
	'section' 	=> 'section_sidebar_layout',
...
$wp_customize->add_section('section_excerpt_length', 
	array(    
	'title'       => __('Excerpt Length', 'notation-blog'),
	'panel'       => 'theme_option_panel'    
	)
);
...
$wp_customize->add_setting( 'theme_options[excerpt_length]', array(
	...
	'sanitize_callback' => 'notation_blog_sanitize_number_range',
) );
$wp_customize->add_control( 'theme_options[excerpt_length]', array(
	'label'       => esc_html__( 'Excerpt Length', 'notation-blog' ),
...
$wp_customize->add_section('section_read_more', 
	array(    
	'title'       => __('Read More Button', 'notation-blog'),
	'panel'       => 'theme_option_panel'    
	)
);
...
$wp_customize->add_setting( 'theme_options[readmore_text]',
	...
	'capability'        => 'edit_theme_options',
	'sanitize_callback' => 'notation_blog_sanitize_textarea_content',
	'transport'         => 'refresh',
	)
);
$wp_customize->add_control( 'theme_options[readmore_text]',
	array(
	'label'    => __( 'Read More Button Label', 'notation-blog' ),
...
$wp_customize->add_section('section_footer', 
	array(    
	'title'       => __('Footer Setting', 'notation-blog'),
	'panel'       => 'theme_option_panel'    
	)
);
...
$wp_customize->add_control( 'theme_options[copyright_text]',
	array(
	'label'    => __( 'Copyright Text', 'notation-blog' ),
